# Phaser Editor Rollup Template

This is a Phaser Editor v4 project template that uses Rollup for bundling. It supports hot-reloading for quick development workflow and includes scripts to generate production-ready builds.
